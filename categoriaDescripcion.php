                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                <div class="row g-3">
                                    <div class="col-2">
                                        <input type="number" class="form-control" style="height:100%" name="cantidad"
                                            id="cantidadUsu" value="1" min="1" max="<?php echo $producto['cantidad'] ?>"
                                            onchange="cantidad123()">
                                    </div>
                      ...
                      ?>
                                    ...
                                    <div class="col-auto">
                                        <a type="submit" class="btn btn-lg" style="background: #144272; color:#fff"
                                            href="./categoriaPagina.php?id=<?php echo $producto['id_categoria'] ?>"
                                            ;>Atras</a>
                                    </div>
