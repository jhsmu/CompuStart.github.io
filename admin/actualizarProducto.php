            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0" hidden>
                        ...
                        type="text" name="id" id="id" value="<?php echo $producto['id_producto']; ?>" >
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                        type="text" name="serial" id="serial" value="<?php echo $producto['serial']; ?>" placeholder="<?php echo $producto['serial']; ?>" required>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        name="producto" id="producto" value="<?php echo $producto['producto']; ?>" placeholder="<?php echo $producto['producto']; ?>"required>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        type="text" name="descripcion_breve" id="descripcion_breve"  value="<?php echo $producto['descripcion_breve']; ?>" placeholder="<?php echo $producto['descripcion_breve']; ?>" required>
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-grey-darker text-xs font-light mb-1"
                               for="grid-city">
                        ...
                        <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                        type="descripcion" name="descripcion" id="descripcion"  value="<?php echo $producto['descripcion']; ?>" placeholder="<?php echo $producto['descripcion']; ?>" required>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                        type="text" name="cantidad" id="cantidad"  value="<?php echo $producto['cantidad']; ?>" placeholder="<?php echo $producto['cantidad']; ?>" required>
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-grey-darker text-xs font-light mb-1"
                               for="grid-city">
                        ...
                        <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                        type="text" name="precio" id="precio"  value="<?php echo $producto['precio']; ?>" placeholder="<?php echo $producto['precio']; ?>" required>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey" id="grid-state" name="marca">
                                <option value="">Seleccione una opción</option>
                                    <?php
